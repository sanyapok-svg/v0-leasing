...
export const MOCK_DEALS: Deal[] = [
  {
    ...
    checks: [
      ...
      { source: "minjust", label: "Minjust.gov.by — реестр залогов", status: "pass", checkedAt: iso(-60 * 4) },
  ...
  },
  {
    ...
    checks: [
      ...
      { source: "minjust", label: "Minjust.gov.by — реестр залогов", status: "pass", checkedAt: iso(-60 * 47) },
    ],
  ...
  },
  {
    ...
    checks: [
      ...
      { source: "minjust", label: "Minjust.gov.by — реестр залогов", status: "pass" },
